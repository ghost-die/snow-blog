...
@section('content')
    ...
    <div class="content">
        <div class="container">
            <form method="post" action="{{route('admin.link.update',['link'=>$link->id]) }}" autocomplete="off" class="form-horizontal">
                @csrf
                @method('put')
                <div class="card ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check mr-auto mt-3">
                                        <label class="form-check-label">
                                            <input class="form-check-input" {{ $link->is_top ? 'checked' : '' }}  name="is_top" value="1" type="radio" > {{ __('Yes') }}
                                            <span class="circle">
                                        ...
                                        <label class="form-check-label offset-1">
                                            <input class="form-check-input" {{ $link->is_top ? '' : 'checked' }} name="is_top" value="0" type="radio" > {{ __('No') }}
                                            <span class="circle">
                                                <span class="check"></span>
                                            </span>
                                        </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9">
                                <div class="form-group ">
                                    <div class="form-check mr-auto mt-3">
                                        <label class="form-check-label">
                                            <input class="form-check-input"  {{ $link->status ? 'checked' : '' }}  name="status" value="1" type="radio" > {{ __('Yes') }}
                                            <span class="circle">
                                                <span class="check"></span>
                                            </span>
                                        </label>
                                        ...
                                        <label class="form-check-label offset-1">
                                            <input class="form-check-input" {{ $link->status ? '' : 'checked' }} name="status" value="0" type="radio" > {{ __('No') }}
                                            <span class="circle">
                                                <span class="check"></span>
                                            </span>
                                        </label>
