...
@section('content')
    ...
    <section class="content">
        <div class="container">
            <form method="post" action="{{route('admin.article.update',['article'=>$article->id]) }}" autocomplete="off" class="form-horizontal">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <label for="category_id" class="col-sm-2 col-form-label text-right">{{ __('Category Name') }}</label>
                            <div class="col-sm-9">
                                <div class="form-group{{ $errors->has('category_id') ? ' has-danger' : '' }}">

                                    <select class="form-control  {{ $errors->has('category_id') ? ' is-invalid' : '' }}" id="category_id" required="true" name="category_id" data-placeholder="{{ __('Category Name') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    <input class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" id="input-email" type="text" placeholder="{{ __('Title') }}" value="{{ old('title')??$article->title  }}" required />
                                    @if ($errors->has('title'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-group">
                                    ...
                                    <textarea id="markdown" name="content" rows="5">{{ $article->original_content }}</textarea>
